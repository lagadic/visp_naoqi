...
FUNCTION(ADD_SAMPLEURDFMODEL name)
  ...
  SET(_urdf_file "${PROJECT_SOURCE_DIR}/share/${name}.urdf")
  SET(_config_file "${PROJECT_SOURCE_DIR}/share/metapod/${name}.config")
  SET(_license_file "${PROJECT_SOURCE_DIR}/share/metapod/metapod_license_file.txt")
  SET(_model_dir "${CMAKE_BINARY_DIR}/include/metapod/models/${name}")
...
FIND_PROGRAM(LMETAPODFROMURDF_EXECUTABLE metapodfromurdf HINTS ${PROJECT_BINARY_DIR}/metapodfromurdf)
  IF(NOT LMETAPODFROMURDF_EXECUTABLE)
    IF(NOT BUILD_METAPODFROMURDF)
      MESSAGE(STATUS "Could not find metapodfromurdf")
     ENDIF()
  ENDIF()

MESSAGE(STATUS "metapodfromurdf found:${LMETAPODFROMURDF_EXECUTABLE}")
